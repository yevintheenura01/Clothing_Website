const Favorite = require("../Model/FavoriteModel"); // Ensure the path is correct
...
exports.getAllFavorites = async (req, res) => {
    try {
        ...
        console.error("Error retrieving favorite items:", error); // Log the error
...
exports.addItemToFavorites = async (req, res) => {
    const { title, price, selectedSize, selectedImage, description } = req.body;
    ...
    try {
        ...
        console.error("Error adding item to favorites:", error); // Log the error
...
exports.removeItemFromFavorites = async (req, res) => {
    ...
    try {
        ...
        console.error("Error removing item from favorites:", error); // Log the error
